...
def make_BF_map(subjectID):
    ...
    stcFile = os.path.join(outDir,
                           'transdef_transrest_mf2pt2_task_raw_buttonPress_duration=3.4s_cleaned-epo_postBetaEvents_DICS')
    ...
    stcMorphFile = os.path.join(outDir,
                                'transdef_transrest_mf2pt2_task_raw_buttonPress_duration=3.4s_cleaned-epo_postBetaEvents_DICS_fsaverage')
    ...
    testCompleteFile = os.path.join(outDir,
                           'transdef_transrest_mf2pt2_task_raw_buttonPress_duration=3.4s_cleaned-epo_postBetaEvents_DICS-lh.stc')
